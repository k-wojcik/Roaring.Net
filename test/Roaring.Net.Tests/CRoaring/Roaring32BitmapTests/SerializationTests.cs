...
public class SerializationTests
{
    public class SerializePortable
    {
        ...
        public void Serialize_Portable_TestBitmap_EqualsToBitmapFromJava()
        {
            ...
            // Assert
            var testData = File.ReadAllBytes($"{nameof(CRoaring)}/{nameof(Roaring32BitmapTests)}/TestData/bitmapwithoutruns.bin");
        ...
        public void Serialize_PortableWithOptimize_TestBitmap_EqualsToBitmapFromJava()
        {
            ...
            // Assert
            var testData = File.ReadAllBytes($"{nameof(CRoaring)}/{nameof(Roaring32BitmapTests)}/TestData/bitmapwithruns.bin");
            Assert.Equal(testData, serializedBitmap);
        }
    ...
    public class Serialize
    {
        ...
        [Fact]
        public void Serialize_Deserialize_SelfTest_WithOptimize_EqualsToDeserialized()
        {
            // Arrange
            using var bitmap = GetTestBitmap();
    ...
    public class DeserializePortable
    {
        ...
        [Fact]
        public void Deserialize_PortableAndInvalidDataCannotDeserialize_ThrowsInvalidOperationException()
        {
            // Act && Assert
    ...
    public class DeserializePortableUnsafe
    {
        [Fact]
        public void DeserializeUnsafe_Portable_DeserializesBitmapFromJava()
        {
            // Arrange
            using var bitmap = GetTestBitmap();
            var testData = File.ReadAllBytes($"{nameof(CRoaring)}/{nameof(Roaring32BitmapTests)}/TestData/bitmapwithoutruns.bin");
        ...
        [Fact]
        public void DeserializeUnsafe_PortableWithOptimize_DeserializesBitmapFromJava()
        {
            // Arrange
            using var bitmap = GetTestBitmap();
            var testData = File.ReadAllBytes($"{nameof(CRoaring)}/{nameof(Roaring32BitmapTests)}/TestData/bitmapwithruns.bin");
        ...
        [Fact]
        public void DeserializeUnsafe_Portable_InvalidDataCannotDeserialize_ThrowsInvalidOperationException()
        {
            // Act
